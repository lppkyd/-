...
Page({
  ...
  onWordInput(e) { 
    this.setData({ word: e.detail.value, autoFilled: false }) 
  },

  onTransInput(e) { 
    this.setData({ trans: e.detail.value, autoFilled: false }) 
  },
